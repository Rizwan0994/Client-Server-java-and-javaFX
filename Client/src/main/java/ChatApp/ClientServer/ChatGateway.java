...
public class ChatGateway implements ChatConstants {
    ...
    public synchronized int getCommentCount() {
        ...
        try {
            ...
            Platform.runLater(() -> textArea.appendText("Error in the getCommentCount: " + ex.toString() + "\n"));
        }
        return count;
    }
    ...
    public synchronized String getComment(int n) {
        ...
        try {
            ...
            Platform.runLater(() -> textArea.appendText("Error in the getComment: " + ex.toString() + "\n"));
        }
        return comment;
    }
}
