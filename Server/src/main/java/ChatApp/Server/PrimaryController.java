...
import static ChatApp.Server.ChatConstants.GET_COMMENT;
import static ChatApp.Server.ChatConstants.GET_COMMENT_COUNT;
import static ChatApp.Server.ChatConstants.SEND_COMMENT;
import static ChatApp.Server.ChatConstants.SEND_HANDLE;
      ...
      try {
        ...
        while (true) {
          ...
          Platform.runLater( () -> {
            ...
            textArea.appendText("Starting the thread for client " + clientNo +
              " at " + new Date() + '\n');
            });
    ...
    public void run() {
      try {
        ...
        while (true) {
          ...
          Platform.runLater(()->textArea.appendText("Exception in client thread: "+ex.toString()+" or connection closed "+"\n"));
      }
    }
  }